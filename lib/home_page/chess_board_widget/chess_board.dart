...
class ChessBoard implements Comparable<ChessBoard> {
  ...
  static ChessBoard generate(List<Queen> queens) =>
      ChessBoard._(queens,  getAttackVectors(queens));
  static ChessBoard random()  {
    ...
    // return queens;
    // }, null);
    return ChessBoard.generate(queens);
  }
  ...
  static List<List<Queen>> getAttackVectors(List<Queen> queens) {
    // return await compute<List<Queen>, List<List<Queen>>>((List<Queen> queens) {
